...
<body>
    ...
    <div class="user-main-content">
      ...
      <div class="reservation-item">
        <h2>Reserva de Visita Guiada</h2>
        <div class="reservation-details">
          <p><span>Fecha:</span> 25 de abril de 2025</p>
          <p><span>Hora:</span> 10:00 AM</p>
          <p><span>Cantidad de personas:</span> 4</p>
          <p><span>Guía asignado:</span> María López</p>
        </div>

        <div class="progress-bar">
          <div class="progress-step completed">Solicitada</div>
          <div class="progress-step completed">Confirmada</div>
          <div class="progress-step active">En curso</div>
          <div class="progress-step">Finalizada</div>
        </div>

        <p class="status-date">Última actualización: 10 de abril de 2025</p>
      </div>

      <div class="reservation-item">
        <h2>Reserva de Taller de Mariposas</h2>
        <div class="reservation-details">
          <p><span>Fecha:</span> 18 de abril de 2025</p>
          <p><span>Hora:</span> 2:00 PM</p>
          <p><span>Participantes:</span> 2</p>
          <p><span>Instructor:</span> José Martínez</p>
        </div>

        <div class="progress-bar">
          <div class="progress-step completed">Solicitada</div>
          <div class="progress-step active">Confirmada</div>
          <div class="progress-step">En curso</div>
          <div class="progress-step">Finalizada</div>
        </div>

        <p class="status-date">Última actualización: 8 de abril de 2025</p>
      </div>
