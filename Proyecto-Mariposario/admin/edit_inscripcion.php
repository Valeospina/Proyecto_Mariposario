...
// Traer los datos actuales, incluyendo Asistio
$stmt = $conn->prepare("
    SELECT *, Asistio 
    FROM Reserva 
    WHERE ID_Reserva = ?
                    ...
                    <form method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" id="cantidad" name="cantidad" 
                                   value="<?= intval($res['Cantidad_Personas']) ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="telefono">Teléfono:</label>
                            <input type="text" id="telefono" name="telefono" 
                                   value="<?= htmlspecialchars($res['Telefono']) ?>">
                        </div>

                        <div class="form-group">
                            <label for="correo">Correo:</label>
                            <input type="email" id="correo" name="correo" 
                                   value="<?= htmlspecialchars($res['Correo']) ?>">
                        </div>
