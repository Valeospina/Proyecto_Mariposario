            ...
            <nav class="sidebar-nav">
                <div class="menu-scroll">
                    <ul>
                        ...
                        <li><a href="eventoAdmin.php" class="<?php echo (in_array(basename($_SERVER['PHP_SELF']), ['eventoAdmin.php', 'add_evento.php', 'edit_evento.php'])) ? 'active' : ''; ?>"><i class="fas fa-calendar-alt"></i> Gestionar Eventos</a></li>
