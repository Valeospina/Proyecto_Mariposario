...
<head>
  ...
  <meta name="description"
    content="Panel de usuario de Eco Mariposas, un espacio donde puedes gestionar tus pedidos, eventos y notificaciones.">
  ...
  <style>
    ...
    .factura-container {
  width: 80%; /* Ajusta el tamaño al 80% del ancho de la pantalla */
  max-width: 600px; /* Limita el tamaño máximo a 600px */
  margin: 40px auto;
  padding: 20px;
  background-color: #fff;
  border-radius: 10px;
...
<body>
  ...
  <div class="factura-container">
    ...
    <div style="text-align: center;">
      <button class="btn-pago" onclick="abrirModal()">Proceder al Pago</button>
    </div>
  </div>
  ...
  <div id="modalPago" class="modal">
    <div class="modal-content">
      ...
      <form action="#" method="post">
        ...
        <input type="text" id="monto" name="monto" value="₡10,500" readonly>
