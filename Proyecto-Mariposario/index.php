							...
							<div class="row">
								<div class="col-lg-7">
									<div class="text">
										...
										<div class="button">
											<a href="tienda.html" class="btn">Explorar tienda</a>
							...
							<div class="row">
								<div class="col-lg-7">
									<div class="text">
										...
										<div class="button">
											<a href="eventos.html" class="btn">Reservar recorrido</a>
								...
								<div class="single-schedule first">
									<div class="inner">
										<div class="single-content">
											...
											<a href="#reservas">Reservar ahora <i class="fa fa-long-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="single-schedule middle">
									<div class="inner">
										<div class="single-content">
											...
											<a href="#talleres">Ver actividades <i class="fa fa-long-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
								...
								<div class="single-schedule last">
									<div class="inner">
										<div class="single-content">
											...
											<a href="#contacto">Contáctanos <i class="fa fa-long-arrow-right"></i></a>
										</div>
									</div>
								</div>
							</div>
			...
			<section class="call-action overlay" data-stellar-background-ratio="0.5">
				...
				<div class="row">
					...
					<div class="content">
						...
						<div class="button">
						<a href="#" class="btn">Visítanos Ahora</a>
						<a href="#" class="btn second">Descubre Nuestras Orquídeas<i class="fa fa-long-arrow-right"></i></a>
						</div>
					</div>
					</div>
				</div>
			...
			<div class="container-fluid">
				...
				<div class="col-lg-12 col-12">
					...
					<div class="single-pf">
						...
						<a href="portfolio-details.html" class="btn">Ver Detalles</a>
					</div>
					<div class="single-pf">
